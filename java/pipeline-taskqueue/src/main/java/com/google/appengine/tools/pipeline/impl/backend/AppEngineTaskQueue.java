...
//    static final int COUNTDOWN_MILLIS = 10000;
//    static final int MAX_BACKOFF_SECONDS = 20;
//    static final int MIN_BACKOFF_SECONDS = 2;
...
//        } catch (com.google.appengine.api.taskqueue.TaskAlreadyExistsException ignore) {
//            // ignore
//        }
//    }
//
...
//        queue.add(
//                TaskOptions.Builder
//                        .withPayload(new AppEngineDeferredTask(deferred))
...
//                if (e.getCause() instanceof com.google.appengine.api.taskqueue.TaskAlreadyExistsException) {

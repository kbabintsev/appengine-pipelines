...
CREATE
NULL_FILTERED INDEX PipelineClassName ON Pipeline(rootJobClassName);

CREATE INDEX PipelineClassNameStartTime ON Pipeline (rootJobClassName, startTime DESC);

CREATE
NULL_FILTERED INDEX PipelineDisplayName ON Pipeline(rootJobDisplayName);
...
(
  ...
  INTERLEAVE IN PARENT Pipeline ON
DELETE
CASCADE;

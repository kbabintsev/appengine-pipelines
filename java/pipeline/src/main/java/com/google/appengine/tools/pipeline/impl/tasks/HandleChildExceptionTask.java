...
public final class HandleChildExceptionTask extends ObjRefTask {
    ...
    public HandleChildExceptionTask(final UUID pipelineKey, final UUID jobKey, final UUID failedChildKey, final QueueSettings queueSettings) {
        super(Type.HANDLE_CHILD_EXCEPTION, "handleChildFailure", pipelineKey, jobKey, queueSettings);

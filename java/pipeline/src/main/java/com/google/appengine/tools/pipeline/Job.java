 ...
 * for some {@code n}.
 * <li> {@link #newPromise()} is used to construct a new
 * {@link PromisedValue}.
...
public abstract class Job<E> implements Serializable {
     ...
     */
    public static JobSetting.WaitForSetting waitFor(final Value<?> fv) {
     ...
     */
    public static JobSetting.BackoffFactor backOffFactor(final int factor) {
     ...
     */
    public static JobSetting.BackoffSeconds backOffSeconds(final int seconds) {
     ...
     * @return a new {@code JobSetting.BackoffSeconds}.
     */
    public static JobSetting.MaxAttempts maxAttempts(final int attempts) {
     ...
     */
    public static JobSetting.StatusConsoleUrl statusConsoleUrl(final String statusConsoleUrl) {
    ...
    // This method will be invoked by reflection from PipelineManager
    @SuppressWarnings("unused")
    private void setUpdateSpec(final UpdateSpec spec) {
        this.updateSpec = spec;
    }

    // This method will be invoked by reflection from PipelineManager
    @SuppressWarnings("unused")
    private void setCurrentRunKey(final UUID key) {
     ...
     * order to specify a data dependency.
     */
    public <T> FutureValue<T> futureCall(final Job0<T> jobInstance, final JobSetting... settings) {
    ...
    public <T, T1> FutureValue<T> futureCall(
            final Job1<T, T1> jobInstance, final Value<? extends T1> v1, final JobSetting... settings) {
     ...
     * order to specify a data dependency.
     */
    public <T, T1, T2> FutureValue<T> futureCall(final Job2<T, T1, T2> jobInstance, final Value<? extends T1> v1,
                                                 final Value<? extends T2> v2, final JobSetting... settings) {
     ...
     * order to specify a data dependency.
     */
    public <T, T1, T2, T3> FutureValue<T> futureCall(final Job3<T, T1, T2, T3> jobInstance,
                                                     final Value<? extends T1> v1, final Value<? extends T2> v2, final Value<? extends T3> v3,
     ...
     * order to specify a data dependency.
     */
    public <T, T1, T2, T3, T4> FutureValue<T> futureCall(final Job4<T, T1, T2, T3, T4> jobInstance,
                                                         final Value<? extends T1> v1, final Value<? extends T2> v2, final Value<? extends T3> v3,
                                                         final Value<? extends T4> v4, final JobSetting... settings) {
     ...
     * order to specify a data dependency.
     */
    public <T, T1, T2, T3, T4, T5> FutureValue<T> futureCall(final Job5<T, T1, T2, T3, T4, T5> jobInstance,
                                                             final Value<? extends T1> v1, final Value<? extends T2> v2, final Value<? extends T3> v3,
                                                             final Value<? extends T4> v4, final Value<? extends T5> v5, final JobSetting... settings) {
    ...
    public <T, T1, T2, T3, T4, T5, T6> FutureValue<T> futureCall(
            final Job6<T, T1, T2, T3, T4, T5, T6> jobInstance, final Value<? extends T1> v1, final Value<? extends T2> v2,
            final Value<? extends T3> v3, final Value<? extends T4> v4, final Value<? extends T5> v5,
            final Value<? extends T6> v6, final JobSetting... settings) {
     ...
     * {@link PipelineService#submitPromisedValue(java.util.UUID, java.util.UUID, Object)}. This
     * may be passed in to further invocations of {@code futureCall()} in
     * order to specify a data dependency.
     ...
     */
    protected final void setStatusConsoleUrl(final String url) {

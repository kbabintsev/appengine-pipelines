...
public final class CancelJobTask extends ObjRefTask {
    ...
    public CancelJobTask(final UUID pipelineKey, final UUID jobKey, final QueueSettings queueSettings) {
        super(Type.CANCEL_JOB, "cancelJob", pipelineKey, jobKey, queueSettings);
    }
